  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="/CourrierDepart" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-paper-plane"></i>Courriers Départs</a>
        <a href="/CourrierArrive" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-paper-plane fa-rotate-180"></i> Courriers arrivés</a>        
       <!-- <a href="/CourierTransmi" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-envelope"></i> Courriers Imputés</a>
        <a href="/Courrier" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-spinner fa-spin"></i> Courriers en cours</a>
        <a href="/Courrier" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-check"></i> Courriers traités</a>
        <a href="/Courrier" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-save"></i> Courriers archivés</a>-->
