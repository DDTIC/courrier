  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="/CourrierDepart" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-spinner fa fa-spin"></i>Courriers en cours</a>
        <a href="/CourrierDepartTransmis" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-paper-plane"></i> Imputations</a>
        <a href="/CourrierDepartImpute" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-check-square"></i> Imputés</a>
        <a href="/CourrierDepartTraite" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-check"></i> Courriers traités</a>
