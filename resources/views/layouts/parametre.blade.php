  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="/Direction" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-home"></i> Directions</a>
        <a href="/Service" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-sitemap"></i> Services</a>
        <a href="/Employe" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-user"></i> Employés</a>
        <a href="/CourrierA" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-paper-plane"></i> Courrier</a>
                                <!-- right control icon-->
                                <div class="accordion" id="accordionRightIcon">
                                    <div class="card">
                                        <div class="card-header header-elements-inline">
                                            <h6 class="card-title ul-collapse__icon--size ul-collapse__right-icon mb-0  "><a class="text-default collapsed  " data-toggle="collapse" href="#accordion-item-icons-1" aria-expanded="false"><span> <i class="fa fa-paper-plane"></i></span> Courriers</a></h6>
                                        </div>
                                ...
                                <!-- /right control icon-->
        <a href="/User" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-user"></i> Utilisateurs</a>
