  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="/Structure" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-home"></i> Structures</a>
        ...
        <a href="/Fonction" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-sitemap"></i> Fonctions</a>
        <a href="/Agent" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-users"></i>Agents</a>    
