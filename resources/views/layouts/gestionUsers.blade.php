  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="/User" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-user-plus"></i> Utilisateurs</a>
        <a href="/Groupe" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-users"></i> Groupes</a>
        <a href="/Role" class="list-group-item list-group-item-action bg-light"> <i class="fa fa-user-secret"></i> Roles</a>
