...
<div class="table-responsive table-hover">
		<h1 style="text-align: center;"> {{$cour->count()}} Courriers Arrivés {{$name}} </h1>
	    <table class="table" id="myTable">
	        <thead class="bg-success" style="color: white;">
	            <tr>
	                <th>No d'ordre</th>
	                <th class="dropdown-toggle" data-toggle="dropdown">Date Arrivés</th>
					    ...
					    <div class="modal-dialog">
					        <div class="modal-content">
					            <div class="modal-header">
					                <h4 class="modal-title"> <i class="fa fa-home icon-lg"></i> Détails Courriers Arrivés</h4>
					            </div>
					            <div class="modal-body">
					            		...
					            		<div class="row">
							            	<p class="col-md-6"> <strong >Expéditeur : </strong></p> <p class="col-md-6">{{$di->destExp}}</p>
							            </div>
					            		<div class="row">
					            		...
					            		<div class="row">
							            	<p class="col-md-6"> <strong >Date de Arrivés : </strong></p> <p class="col-md-6">{{$di->dateArrivee}}</p>
							            </div>
					            		<div class="row">
						        ...
						        <div class="modal-content">
						            ...
						            <div class="modal-body">
										...
										{{method_field('PUT')}}
										  <div class="form-row">
										  	 <div class="form-group col-md-3">
												<select class="form-control" name="typeCour">
													     <option value="Arrive" selected="true">Arrivés</option>
												</select>
											</div>							
										  </div>
											  <div class="form-row">
										  ...
										  <div class="form-group col-md-3">
										    <label for="inputAddress" class="col-sm-12 control-label">Date d'Arrivés</label>
										 ...
										 <hr>
										  ...
										  <div class="form-row">
										    <div class="form-group col-md-4">
										      <label for="inputState" class="col-sm-12 control-label">Expéditeur</label>
