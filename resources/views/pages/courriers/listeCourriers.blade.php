...
<div class="table-responsive table-hover">
		<h1 style="text-align: center;"> {{$cour->count()}} Courriers  </h1>
	    <table class="table" id="myTable">
	        ...
	        @if($cour->count()>0)
					    ...
					    <div class="modal-dialog">
					        <div class="modal-content">
					            ...
					            <div class="modal-body">
					            		<div class="row">
							            	<p class="col-md-6"> <strong >Numéro d'ordre : </strong></p>  <p class="col-md-6">D0{{$di->id}}</p>
							            </div>
					            				<div class="row">
							            			<p class="col-md-6"><strong>Structure : </strong></p>  <p class="col-md-6">{{$di->structures['nomStruct']}}</p>
							            		</div>
					            		<div class="row">
				...
				<!-- Modal  de transmission de courriers-->
						...
						<div class="modal fade bd-example-modal-xl" id="myModalM_{{$di->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						    <div class="modal-dialog modal-xl">
						        <div class="modal-content">
						            <div class="modal-header modal-header-success" style="text-align: center;display: block;">
						                <h4 class="modal-title" > <i class="fa fa-home icon-lg"></i>  MODIFIER UN COURIER DEPART	 </h4>
						            </div>
						            <div class="modal-body">
										...
										{{method_field('PUT')}}
										  ...
										  <div class="form-group col-md-3">
										    <label for="inputAddress" class="col-sm-12 control-label">Date de départ</label>
	    	 ...
	    	 @else
	        	<h2 style="text-align: center; color: red;">Aucun courrier en cours pour le moment</h2>
	       	  @endif
